...
ArchHyperParameters = namedtuple(
    "ArchHyperParameters",
    [
        "batch_size",
        "sequence_length",
...
AlphaStar_Arch_Hyper_Parameters = ArchHyperParameters(
    batch_size=int(512 / AlphaStar_Input_Scale),
...
MiniStar_Arch_Hyper_Parameters = ArchHyperParameters(
    batch_size=int(16 * 8 / P.Batch_Scale),
...
SLTrainingHyperParameters = namedtuple(
...
RLTrainingHyperParameters = namedtuple(
...
RL_Training_Hyper_Parameters = RLTrainingHyperParameters(
    learning_rate=1e-5,  # AlphaStar: 3e-5
    beta1=0.9,
    beta2=0.999,
    epsilon=1e-8,
    weight_decay=0,
...
AgentInterfaceFormatParams = namedtuple(
...
AlphaStar_Agent_Interface_Format_Params = AgentInterfaceFormatParams(
...
StarCraftHyperParameters = namedtuple(
